...
#include "../../runQProcess/tesqprocess.h"
...
struct qt_meta_stringdata_tesQProcess_t {
    QByteArrayData data[5];
    char stringdata[62];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_tesQProcess_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_tesQProcess_t qt_meta_stringdata_tesQProcess = {
    {
...
QT_MOC_LITERAL(4, 39, 21)
    ...
    "tesQProcess\0rightMessage\0\0wrongMessage\0"
...
const QMetaObject tesQProcess::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_tesQProcess.data,
      qt_meta_data_tesQProcess,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_tesQProcess.stringdata))
